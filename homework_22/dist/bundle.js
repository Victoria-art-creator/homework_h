...
;// ./src/pexels-jason-v-2158569237-35464406.jpg
const pexels_jason_v_2158569237_35464406_namespaceObject = __webpack_require__.p + "images/pexels-jason-v-2158569237-354644066d1f8148ec48794f4c5f.jpg";
;// ./src/index.js
...
const src_form = jquery_default()(".js--form");
const input = jquery_default()(".js--form__input");
const todosWrapper = jquery_default()(".js--todos-wrapper");
...
todosWrapper
  .on("change", 'input[type="checkbox"]', function () {
    const id = Number(jquery_default()(this).closest("li").data("id"));
    toggleTodo(id);
  })
  ...
  .on("click", ".todo-item__description", function () {
    const $li = jquery_default()(this).closest("li");
    const id = Number($li.data("id"));
    const todo = todos.find((t) => t.id === id);
    if (!todo) return;

    // show modal with bootstrap
    jquery_default()("#todoModalBody").text(todo.text);
...
function renderTodos() {
  ...
  todos.forEach((todo) => {
    ...
    const li = jquery_default()("<li>").addClass("todo-item").attr("data-id", todo.id);
    ...
    // Checkbox
    const checkbox = jquery_default()('<input type="checkbox">').prop("checked", !!todo.done);

    // Text
    const span = jquery_default()("<span>")
      .addClass("todo-item__description")
      .text(todo.text)
      .attr("title", "Click to see");

    // Delete button
    const delBtn = jquery_default()(
...
img.src = pexels_jason_v_2158569237_35464406_namespaceObject;
img.alt = "Prague";
img.width = 300;
img.height = 300;
